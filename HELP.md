...
* The original package name 'com.dagnerchuman.spring-boot-microservice-1-Product' is invalid and this project uses 'com.dagnerchuman.springbootmicroservice1Product' instead.
...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/2.7.14/reference/htmlsinge/index.html#howto.data-access.exposing-spring-data-repositories-as-rest)
